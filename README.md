...
# Principaux problèmes ou choses a savoir
  ...
  La branch [`main`](https://github.com/angerenage/SI_Ange/) ne contient pas le code arduino, pour pouvoir y accéder rendez vous dans la branch [`arduino`](https://github.com/angerenage/SI_Ange/tree/arduino) et le code est accéssible dans le fichier `bombe`.  
